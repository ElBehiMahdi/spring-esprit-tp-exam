package com.example.scrumexamen.Config;
...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors.basePackage("com.example.scrumexamen")) // basePackage permet de demander à Swagger de ne rien documenter en dehors du package "com.esprit.examen".
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("Swagger Configuration for eXam")
